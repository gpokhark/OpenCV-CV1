...
* https://www.youtube.com/watch?v=SCgrQIPx_3E
* https://en.wikipedia.org/wiki/Image_formation
* https://en.wikipedia.org/wiki/Channel_(digital_image)
* https://docs.opencv.org/4.1.0/dc/d2e/tutorial_py_image_display.html
* https://docs.opencv.org/4.1.0/d3/df2/tutorial_py_basic_ops.html
* https://pythonprogramming.net/loading-images-python-opencv-tutorial/
## Basic Image Operations
* https://pysource.com/2018/01/24/basic-operations-on-images-opencv-3-4-with-python-3-tutorial-4/
...
## Assignment - QR Code Detector
* https://www.learnopencv.com/opencv-qr-code-scanner-c-and-python/
* https://www.learnopencv.com/barcode-and-qr-code-scanner-using-zbar-and-opencv/
* https://www.youtube.com/watch?v=-4MPtERPq2E&t=1s

# Week 2 - Video I/O and GUI
## Introduction
* https://www.learnopencv.com/read-write-and-display-a-video-using-opencv-cpp-python/
* https://docs.opencv.org/4.1.0/dd/d43/tutorial_py_video_display.html
* https://pysource.com/2018/01/20/loading-video-and-webcam-opencv-3-4-with-python-3-tutorial-2/
* https://www.youtube.com/watch?v=Jvf5y21ZqtQ&t=179s
...
## Using the Keyboard as Input Device
## Using the Mouse for Annotation
* https://docs.opencv.org/4.1.0/db/d5b/tutorial_py_mouse_handling.html
* https://www.youtube.com/watch?v=rrh-4NtuK-w
* https://www.youtube.com/watch?v=rrh-4NtuK-w
* https://pysource.com/2018/03/27/mouse-events-opencv-3-4-with-python-3-tutorial-27/
## Adding a Trackbar as Controller
* https://docs.opencv.org/4.1.0/d9/dc8/tutorial_py_trackbar.html
* https://pysource.com/2018/01/30/trackbars-opencv-3-4-with-python-3-tutorial-8/
* https://www.youtube.com/watch?v=fM6ff3VEviI
* https://www.youtube.com/watch?v=o6XXbXX11T4
...
* https://pysource.com/2018/02/27/morphological-transformation-opencv-3-4-with-python-3-tutorial-17/
...
* https://www.youtube.com/watch?v=9lqH5XLI-V4
* https://docs.opencv.org/4.1.0/d9/d61/tutorial_py_morphological_ops.html
## Opening and Closing
* https://docs.opencv.org/4.1.0/d9/d61/tutorial_py_morphological_ops.html
* https://en.wikipedia.org/wiki/Opening_(morphology)
* https://en.wikipedia.org/wiki/Closing_(morphology)
* https://www.youtube.com/watch?v=GRxrfOTyoOM
* https://www.youtube.com/watch?v=uv10u-SIM8A
## Connected Components Analysis
* https://youtu.be/hMIrQdX4BkE
...
* https://www.linkedin.com/pulse/blob-detection-satellite-imagery-using-opencv-andrew-cutts/
...
# Week 4 - Image Enhancement and Filtering
## Introduction
## Download Code
## Online Labs
## Color Spaces
...
## Color Spaces Assignment
* https://www.dynamsoft.com/blog/insights/image-processing-101-color-space-conversion/
...
# Week 5 - Advanced Image Processing & Computational Photography
## Introduction
## Download Code
## Online Labs
## Hough Transforms
* https://docs.opencv.org/4.1.0/d6/d10/tutorial_py_houghlines.html
* https://docs.opencv.org/4.1.0/da/d53/tutorial_py_houghcircles.html
...
* https://docs.opencv.org/4.1.0/d2/df0/tutorial_py_hdr.html
* https://en.wikipedia.org/wiki/High-dynamic-range_imaging
* https://www.cl.cam.ac.uk/~rkm38/pdfs/mantiuk15hdri.pdf
* https://www.cs.cmu.edu/afs/cs/academic/class/15462-s12/www/lec_slides/hdr.pdf
...
## Image Inpainting
* https://docs.opencv.org/4.1.0/df/d3d/tutorial_py_inpainting.html
...
* https://www.youtube.com/watch?v=0jItKb9sAkw
...
## Application - Finding known Objects in Images
...
## Assignment - Creating Panorama from multiple images
* https://en.wikipedia.org/wiki/Panorama
* https://en.wikipedia.org/wiki/Image_stitching
* https://www.pyimagesearch.com/2018/12/17/image-stitching-with-opencv-and-python/
* https://towardsdatascience.com/image-panorama-stitching-with-opencv-2402bde6b46c
...
## Online Labs
## Download Code
## Binary Segmentation using Grabcut
...
* https://en.wikipedia.org/wiki/Simple_interactive_object_extraction
## Introduction to AI
...
* https://www.youtube.com/watch?v=q7bKMHdxtPU
...
## Tracking using Kalman Filter [Optional]
...
## MeanShift and CamShift [Optional]
...
# Week 10 - Deep Learning in OpenCV
## Introduction
## Online Labs
## Download Code
...
* https://hackernoon.com/how-to-make-snapchat-lenses-f9eae861b5db
## Project 3
